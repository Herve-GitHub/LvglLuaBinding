...
-- 创建三个阀门
local v1 = Valve.new(scr, { x = 100, y = 100, title = "Valve 1" ,design_mode = false})
local v2 = Valve.new(scr, { x = 300, y = 100, title = "Valve 2" ,design_mode = false})
local v3 = Valve.new(scr, { x = 500, y = 100, size = 120, handle_color = "#2196F3", label = "V3" ,design_mode = false})
...
-- 创建控制按钮（注意：需要设置 design_mode = false 才能响应点击事件）
local btn_open_all = Button.new(scr, { x = 50, y = 300, width = 150, height = 50, label = "一键全开", bg_color = "#4CAF50", design_mode = false })
local btn_close_all = Button.new(scr, { x = 250, y = 300, width = 150, height = 50, label = "一键全关", bg_color = "#F44336", design_mode = false })
